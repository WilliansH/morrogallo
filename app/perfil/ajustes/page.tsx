...
export const metadata = { title: "Ajustes de mi cuenta" };
  ...
  return (
    <>
      ...
      <div className="mx-auto max-w-2xl px-6 py-16 md:py-20">
        ...
        <h1 className="font-display text-4xl mt-6">Ajustes</h1>
        <p className="cifra text-sm text-tinta-400 mt-2">{user.email}</p>

        {/*
          * Índice de los ajustes. Son anclas: funcionan sin JavaScript, y cada
          * sección nueva que se agregue (cédula, notificaciones…) entra aquí.
          */}
        <nav className="flex flex-wrap gap-x-5 gap-y-2 mt-6 cifra text-[11px] uppercase tracking-[0.14em] text-tinta-600">
          <a href="#foto" className="hover:text-tinta-900">Foto</a>
          <a href="#datos" className="hover:text-tinta-900">Tus datos</a>
          <a href="#clave" className="hover:text-tinta-900">Contraseña</a>
          <a href="#cuenta" className="text-estrella-600 hover:text-estrella-500">Borrar cuenta</a>
        </nav>
        ...
        {/* ---------------- Foto ---------------- */}
        <section id="foto" className={`${seccion} mt-10 scroll-mt-24`}>
        ...
        {/* ---------------- Datos ---------------- */}
        <form id="datos" action={guardarDatos} className={`${seccion} mt-6 scroll-mt-24`}>
        ...
        {/* ---------------- Contraseña ---------------- */}
        <form id="clave" action={cambiarClave} className={`${seccion} mt-6 scroll-mt-24`}>
        ...
        {/*
          ...
          */}
        <details id="cuenta" className="border border-estrella-500/40 bg-white/60 mt-6 scroll-mt-24">
